    ...
    <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-full max-w-7xl px-4 sm:px-6">
      ...
      >
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          {/* Add transaction CTA */}
          <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold bg-primary text-primary-foreground hover:bg-primary/90 transition-[background-color,color,box-shadow,transform] duration-150 ease-out hover:-translate-y-px">
