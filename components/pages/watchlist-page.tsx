              ...
              return (
                ...
                >
                  ...
                  <td className="py-3.5 text-right">
                    ...
                    <p className={cn('text-[10px]', isPositive ? 'text-gain/70' : 'text-loss/70')}>
                      {isPositive ? '+' : ''}{item.changeAbs.toFixed(2)} €
                    </p>
                  </td>
                  <td className="py-3.5 pr-5 text-right">
                    <button className="opacity-0 group-hover:opacity-100 p-1.5 rounded-lg hover:bg-surface-3 transition-all text-muted-foreground hover:text-foreground">
